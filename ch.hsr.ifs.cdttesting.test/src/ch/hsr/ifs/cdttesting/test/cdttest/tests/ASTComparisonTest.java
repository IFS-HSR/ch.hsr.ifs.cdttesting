...
public class ASTComparisonTest extends AST2TestBase {
	...
	private void assertSameAST() throws IOException, ParserException {
		Pair<ComparisonState, String[]> equals = compareASTs();
		switch (equals.first) {
		case EQUAL:
			assertTrue(true);
			break;
	...
	private Pair<ComparisonState, String[]> compareASTs() throws IOException, ParserException {
		...
		Pair<ComparisonState, String[]> equals = ASTComparison.equals(first, second);
		return equals;
	}

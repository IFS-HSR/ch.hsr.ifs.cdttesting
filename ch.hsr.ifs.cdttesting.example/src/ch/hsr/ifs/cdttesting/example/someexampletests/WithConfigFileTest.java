...
public class WithConfigFileTest extends CDTTestingTest {
	...
	protected void configureTest(Properties properties) {
		...
		intProperty = Integer.parseInt(properties.getProperty("someOtherKey", "0")); // passing 0 as default if property isn't existing, otherwise you will get a NPE.
		boolProperty = Boolean.parseBoolean(properties.getProperty("yetAnotherKey", "false")); // again, passing false as default.
	}
}

...
public class TestFileLabelProvider extends LabelProvider {
    private static final Image TEST_FILE = ImageDescriptor
    ...
    private static final Image LANGUAGE = ImageDescriptor
            .createFromURL(Activator.getDefault().getBundle().getEntry("icons/lang.gif")).createImage();
    private static final Image EXPECTED = ImageDescriptor
    ...
    private static final Image CLASS = ImageDescriptor
